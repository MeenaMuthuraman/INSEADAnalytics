...
author: "Meena, Zhenfu, Sagar, Swapnil, Kate"
output:
  html_document:
...
**Answers:**
<br>
1. We assume that 0.5 is considered high correlation. Yes, we see some high correlations between the response such as in reponses to questions 3, 9, 13 and 14. It makes sense because they all relate to purchasing boats and accessories in relation to the brand and status of the products.  
<br>
2. These correlations imply that the answers are related to the each other and hence, the questions relate to a similar parameter. For instance questions 3, 9, 13 and 14 are all related to brand and status as reasons for purchase of boats and accessories.
<br>
...
1. The table indicates that the first 5 components explain close to 53% of the variance. We can learn that the first 5 components are probably the most important in explaining the purchasing behaviour of people in buying boats. 
<br>
2. The plot has the following shape to explain that the first 5 components, with eigne values greater than 1 are more accurate in explaining the variable than each of the individual factors alone.
<br>
3. We would prefer to see that the individual factors making up the components are all related to a specific parameter so that we can group them together under a common name that can help to explain the purchasing behaviour of boats.
...
1. Component 1 relates to interest in boating. Component 2 relates to to quality and trendiness. Component 3 relates to escapists. Component 4 relates to pride of ownership. Component 5 relates to price sensistivity.
<br>
2. We should choose 5 values. Statistically, we made a choice based on eigen values. The individual components can also be interpreted as specific factors and we believe they can be reasonabley used to make a business judgment on boats purchasing decisions.
<br>
3. Component 1 relates to interest in boating. Component 2 relates to to quality and trendiness. Component 3 relates to escapists. Component 4 relates to pride of ownership. Component 5 relates to price sensistivity.
