...
<br>
2. The cumulative daily returns of Apple is `r round(100*sum(StockReturns[,2]),1)` %.
<br>
...
<br>
2. You will get an error as the variables myData and StockReturns dont match up. myData has date, SPY and AAPL returns all lumped together with 20 observations, while StockReturns has date as a header and returns of SPY, AAPL and YHOO for 4028 observations.
